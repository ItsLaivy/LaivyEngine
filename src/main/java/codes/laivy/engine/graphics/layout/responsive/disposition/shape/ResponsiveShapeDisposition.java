...
public abstract class ResponsiveShapeDisposition extends ResponsiveDisposition {
    ...
    public abstract void fill(@NotNull Graphics2D renderingGraphics, @NotNull Location location, @NotNull codes.laivy.engine.coordinates.dimension.Dimension dimension, @NotNull GameLayout.Bounds bounds);

    public abstract void shape(@NotNull Graphics2D renderingGraphics, @NotNull Location location, @NotNull codes.laivy.engine.coordinates.dimension.Dimension dimension, @NotNull GameLayout.Bounds bounds);
