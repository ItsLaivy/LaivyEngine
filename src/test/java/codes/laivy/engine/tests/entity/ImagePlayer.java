...
public class ImagePlayer extends Player {
    ...
    public ImagePlayer(@NotNull String name, @NotNull ImageAsset asset, @NotNull Location location) {
        ...
        this.image = new ImageComponent(TestGame.instance(), getLocation().clone(), new Dimension(35, 35), 0, 0, asset);
        ...
        getSquare().getGame().getGraphics().runWindowThreadLater(this.image::add);
    }
